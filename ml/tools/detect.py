...
def detect_facial_landmarks(gray_img, cascade_model_path, landmark_model_path):
    ...
    for face in faces_roi:
        ...
        landmarks = []
        landmarks.append(numpy.array([[p.x, p.y] for p in predictor(gray_img, rects).parts()]))
    return landmarks
...
def draw_landmarks(img_path, cascade_model_path, landmark_model_path):
    ...
    landmarks = detect_facial_landmarks(gray_img, cascade_model_path, landmark_model_path)
