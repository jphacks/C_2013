...
def main():
    ...
    if args.mode == 'video':
        detect(cascade_models[args.cascade], models[args.model]).draw_landmarks_video()

    else:
        detect(cascade_models[args.cascade], models[args.model]).draw_landmarks_img(args.img_path)
